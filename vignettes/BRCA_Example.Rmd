...
* rank 20 structure individual to gene expression
* rank 12 structure individual to methylation, and
* rank 18 structure individual to miRNA.
...
```Results = jive(Data,method="given",rankJ=2,rankA=c(20,12,18)) ```  
